...
function AboutSlamburger() {
    return (
        <section id="about-slamburger" className="w-full pt-25 pb-20 mx-auto md:px-8">
            <div className="relative overflow-hidden py-16 md:py-24 md:px-16">
                ...
                <motion.div {...getSectionAnim({ direction: "", delay: 0.1 })} className="relative z-10 max-w-[1400px] mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-16 text-center md:text-left">
                    ...
                    <div className="max-w-2xl mb-75 md:ml-15">
                        <h2 className="text-7xl sm:text-7xl lg:text-9xl lg:tracking-wide font-[Anton] text-black tracking-wide leading-tight mb-8">
                    ...
                    {/* Right: Chef Image */}
                    <div className="w-full max-w-[600px] lg:max-w-[800px] lg:mb-35">
                        <Image
...
function OurStory() {
    return (
        <section id="our-story" className="w-full px-2 md:px-8 py-20">
            <div className="relative overflow-hidden py-20 px-2 md:px-16">
                {/* Background image - preserved */}
                <img
                ...
                <div className="relative z-10 max-w-[1200px] mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-16 text-center md:text-left md:mt-20">
                    {/* Text content */}
                    <motion.div {...getSectionAnim({ direction: "left", delay: 0.1 })} className="w-90 md:w-125">
                        <h2 className="text-7xl sm:text-7xl lg:text-9xl tracking-wide font-[Anton] text-black leading-tight mb-8">
...
function WhatWeStandFor() {
    return (
        <section
            ...
            className="relative w-full min-h-[900px] px-0 pt-24 relative left-1/2 right-1/2  "
        ...
        >
            <div className="relative min-h-[900px] overflow-hidden py-12 px-2 sm:px-8">
                ...
                <div className="relative z-10 max-w-[1400px] mx-auto text-center">
                    <motion.h2 {...getSectionAnim({ direction: "", delay: 0.1 })} className="text-7xl sm:text-7xl lg:text-9xl font-[Anton] mb-16 text-black">
                        WHAT WE STAND FOR
                    </motion.h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 lg:gap-16 text-center items-stretch">
                        {/* Block 1 */}
                        <motion.div {...getSectionAnim({ direction: "up", delay: 0.2 })} className="relative flex flex-col items-center text-center h-[225px] md:h-[350px] space-y-6 shadow-md p-10 rounded-[3rem] bg-white/20">
                            <Image
                            ...
                            <div className="absolute bottom-0 left-0 w-full px-6 pb-6">
                                <h3 className="text-2xl sm:text-3xl lg:text-5xl lg:mb-5 font-bold">Quality</h3>
                        ...
                        {/* Block 2 */}
                        <motion.div {...getSectionAnim({ direction: "up", delay: 0.3 })} className="relative flex flex-col items-center text-center h-[225px] md:h-[350px] space-y-6 shadow-md p-10 rounded-[3rem] bg-white/20">
                            <Image
                            ...
                            />
                            <div className="absolute bottom-0 left-0 w-full px-6 pb-6">
                                <h3 className="text-2xl sm:text-3xl lg:text-5xl lg:mb-5 font-bold">Freshness</h3>
                                <p className="text-gray-800 text-base sm:text-xl lg:text-2xl font-medium">
                        ...
                        {/* Block 3 */}
                        <motion.div {...getSectionAnim({ direction: "up", delay: 0.4 })} className="relative flex flex-col items-center text-center h-[225px] md:h-[350px] space-y-6 shadow-md p-10 rounded-[3rem] bg-white/20">
                            <Image
                            ...
                            />
                            <div className="absolute bottom-0 left-0 w-full px-6 pb-6">
                                <h3 className="text-2xl sm:text-3xl lg:text-5xl lg:mb-5 font-bold">Community</h3>
                                <p className="text-gray-800 text-base sm:text-xl lg:text-2xl font-medium">
...
function OurValues() {
    return (
        <section id="our-values" className="w-full w-full px-2 md:px-8 py-20">
            <div className="relative overflow-hidden py-24 px-2 md:px-16">
                <div className="relative z-10 max-w-[1500px] mx-auto text-center">
                    ...
                    <div className="w-full mb-5">
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
                            <motion.div {...getSectionAnim({ direction: "up", delay: 0.2 })} className="flex flex-col bg-white/50 items-center text-center px-4 py-8 rounded-[2rem] shadow-xl border border-orange-100 transition hover:shadow-2xl hover:-translate-y-1">
                                <Image
                            ...
                            {/* Value Block 2 */}
                            <motion.div {...getSectionAnim({ direction: "up", delay: 0.3 })} className="flex flex-col bg-white/50 items-center text-center px-4 py-8 bg-white rounded-[2rem] shadow-xl border border-orange-100 transition hover:shadow-2xl hover:-translate-y-1">
                                <Image
                            ...
                            {/* Value Block 3 */}
                            <motion.div {...getSectionAnim({ direction: "up", delay: 0.4 })} className="flex flex-col bg-white/50 items-center text-center px-4 py-8 bg-white rounded-[2rem] shadow-xl border border-orange-100 transition hover:shadow-2xl hover:-translate-y-1">
                                <Image
                                    ...
                                    className="mb-6"
                                />
                                <h3 className="text-3xl sm:text-4xl font-bold mb-2">VELOCITY</h3>
                                <p className="text-gray-800 text-lg sm:text-xl lg:text-2xl">
                                    We go the extra mile to serve our customers.
                                </p>
                            </motion.div>
                        ...
                        <div className="w-full mt-10 grid md:grid-cols-2 gap-10">
                            {/* PASSION Card */}
                            <motion.div {...getSectionAnim({ direction: "up", delay: 0.5 })} className="flex flex-col bg-white/50 items-center text-center px-4 py-8 bg-white bg-opacity-80 rounded-[2rem] shadow-xl border border-orange-100 transition hover:shadow-2xl hover:-translate-y-1">
                                <Image
                            ...
                            {/* COMMUNITY Card */}
                            <motion.div {...getSectionAnim({ direction: "up", delay: 0.6 })} className="flex flex-col bg-white/50 items-center gap-6 px-4 py-8 bg-white bg-opacity-90 rounded-[2rem] shadow-xl border border-orange-100 transition hover:shadow-2xl hover:-translate-y-1">
                                <Image
...
function OurTeam() {
    return (
        <section
            id="our-team"
            className="relative w-full min-h-[600px] px-0 pt-20 relative left-1/2 right-1/2 "
            style={{ transform: "translateX(-50%)" }}
        >
            <div className="relative overflow-hidden py-16 px-2 md:px-8 lg:px-12">
                {/* Decorative background */}
                <img
                    src="/4-about/5-team/5-team_bg_shapes.png"
                    alt="Background decoration"
                    className="absolute left-0 w-360 mx-15 pointer-events-none"
                />

                {/* EXPANDED CONTAINER */}
                <div className="relative z-10 max-w-[1800px] mx-auto mt-20 text-center">
...
function VisitUs() {
    return (
        <section id='visit-us' className="relative overflow-hidden w-full md:h-[1000px] mx-auto px-6">
            <div className="relative overflow-hidden py-65 px-6 sm:px-12 w-full h-[1000px] md:h-[950px]">
                {/* Decorative background */}
                <img
                    src="/4-about/6-visit/bg_shapes.png"
                    alt="Decorative background"
                    className="absolute w-350 left-5 bottom-0 pointer-events-none"

                />

                <div className="relative z-10 max-w-6xl mx-auto flex flex-col-reverse md:flex-row md:bottom-15 items-center justify-between gap-12">
                    {/* Left: Text */}
